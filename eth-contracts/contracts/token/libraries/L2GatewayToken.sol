...
import "../token/IGwToken.sol";

/**
 * @title Standard (i.e., non-custom) contract used as a base for different L2 Gateways
 */
abstract contract L2GatewayToken is geERC20, IGwToken {
    address public l2Gateway;
    bytes public override l1Address;
     ...
     * @param l1Counterpart_ L1 address of SUDT
     */
    function _initialize(
        ...
        geERC20._initialize(name_, symbol_, decimals_);
    }
